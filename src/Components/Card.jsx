...
function Card(props) {
  return (
        ...
        <motion.div className='w-96 flex h-64 border-2 sm:w-1/3 border-gray-400 rounded-lg m-7 sm:m-10 hover:shadow-xl shadow-xl shadow-gray-400 hover:shadow-gray-500'
          initial={{opacity: 0.2}}
